...
// 5. Create an object called catObject with 3 properties:
...
// 8. Loop throughcatArray and console log each property of each object inside
// (there will be only 1 object inside).
for (var i = 0; i < catArray.length; i++) {
  console.log(catArray[i]);
}

// 9. Create a function called logToConsole. The function should accept 1 argument.
